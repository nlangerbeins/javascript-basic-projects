...
form.addEventListener('submit', (e) => {
  e.preventDefault();
  // we need to use parseInt to convert string into a number, even if type of input is number. It still a string in a console
  ...
  // if the user doesn't entry any number or bigger than 9
